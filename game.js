class DNAGame {
    ...
    setupDragAndDrop() {
        ...
        document.addEventListener('touchmove', (e) => {
            if (e.target.classList.contains('base-item')) {
                e.preventDefault();
            }
        }, { passive: false });
        ...
        baseItems.forEach(item => {
            ...
            item.addEventListener('touchend', (e) => {
                ...
                // Importante: usar clientX/Y para encontrar o elemento sob o dedo no final do toque
                const element = document.elementFromPoint(touch.clientX, touch.clientY);
                const slot = element ? element.closest('.base-slot') : null;
                
                // Verifica se o slot pertence à fita da direita e não está preenchido
